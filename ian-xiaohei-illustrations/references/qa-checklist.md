...
- 是 16:9 横版。
- 背景是干净白底。
- 有 ESentient，且标志特征完整：卷发、黑框眼镜、大耳朵、白 T 恤。
- ESentient 承担核心动作，不只是装饰。
...
- ESentient 像吉祥物、表情包或可爱卡通。
- ESentient 形象漂移：没戴黑框眼镜、不是卷发、不穿白 T 恤，或变成其他角色。
- 画面像 PPT、课程课件、正式流程图。
- 元素太多、箭头太多、节点太多。
- 文字变成大段解释。
- 背景有纸纹、阴影、渐变、米色、噪点。
